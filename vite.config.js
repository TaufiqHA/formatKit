    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/tools/json-to-yaml.js',
                'resources/js/tools/xml-to-json.js',
                'resources/js/tools/timestamp-converter.js',
                'resources/js/tools/xpath-tester.js',
                'resources/js/tools/lorem-ipsum.js',
                'resources/js/tools/provinsi-indonesia.js',
                'resources/js/tools/kode-pos-indonesia.js',
                'resources/js/tools/mime-types.js',
                'resources/js/tools/xsd-to-json-schema.js',
                'resources/js/tools/kode-bank-indonesia.js',
            ],
            refresh: true,
            fonts: [
                bunny('Space Grotesk', {
