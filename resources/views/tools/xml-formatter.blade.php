<x-tools.shell :tool="$tool" :catalog="$catalog">
    <x-tools.workspace input-label="XML"
                      input-hint="tempel dokumen di sini"
                      output-label="Hasil"
                      placeholder="&lt;root&gt;&lt;item&gt;nilai&lt;/item&gt;&lt;/root&gt;">
        <x-slot:actions>
            ...
            <x-ui.button data-action="download" variant="quiet">Unduh .xml</x-ui.button>
        </x-slot:actions>
