<x-tools.shell :tool="$tool" :catalog="$catalog">
    <x-tools.workspace input-label="JavaScript"
                      input-hint="tempel kode JS di sini"
                      output-label="Hasil JS"
                      placeholder="function halo(nama) { return `Halo, ${nama}!`; }">
        <x-slot:actions>
            ...
            <x-ui.button data-action="validate" variant="info">Validasi</x-ui.button>
            ...
            <x-ui.button data-action="download" variant="quiet">Unduh .js</x-ui.button>
        </x-slot:actions>
