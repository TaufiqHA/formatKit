<x-tools.shell :tool="$tool" :catalog="$catalog">
    <x-tools.workspace input-label="JSON"
                      input-hint="tempel JSON di sini"
                      output-label="Hasil"
                      placeholder='{"nama": "FormatKit", "privat": true}'>
        <x-slot:actions>
            ...
            <x-ui.button data-action="sort" variant="accent">Urutkan kunci</x-ui.button>
