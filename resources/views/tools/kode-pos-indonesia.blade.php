<x-tools.shell :tool="$tool" :catalog="$catalog">
    <x-tools.workspace input-label="Kata Kunci Pencarian"
                      input-hint="ketik nama kota, kecamatan, kelurahan, atau nomor kode pos"
                      output-label="Hasil Pencarian Kode Pos"
                      placeholder="contoh: Bandung, Menteng, Surabaya, atau 40111">
        <x-slot:actions>
            <x-ui.button data-action="search" variant="primary">Cari Kode Pos</x-ui.button>
